...
pos = [
    "0:0-512:512",
    imageM,
]  # the first position should occupy the entirety of the picture size. it works the following: x0:y0-x1:y1 in pixels. the image passed is in black and white
mask_types = [
    1,
    12,
]  # the numbers here are essentially the equivalent of z-index in css less strength to background and more strength to mask.
